    ...
    <div className="contact" id="contact">
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md grid">
            <h2 className="mb-4 pb-2 m-auto text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white border-b-4 border-pink-600">Contact me</h2>
